 ...
 * @author : GasComIT <https://github.com/GasComIT/Secktor-Md>
...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        await Void.sendMessage(`${citel.sender}`, {
            image: log0,
            caption: `*Group Name: ArctixBots*\n*Group Link:* https://chat.whatsapp.com/BgDWgdVAbHZK4ZoJ4MPTcy\n\n*Ultron Bot ©*`,
        });
